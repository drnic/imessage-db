...
class TestExtractedRealData < Minitest::Test
  ...
  def test_extracted_messages_have_attributes
    ...
    [@message_155181_data, @message_155192_data, @message_155194_data, @message_155196_data].each_with_index do |data, i|
  ...
  def test_performance_with_extracted_data
    ...
    [@message_155181_data, @message_155192_data, @message_155194_data, @message_155196_data].each do |data|
      5.times do
  ...
  def test_debug_string_extraction_priorities
    ...
    [@message_155181_data, @message_155192_data, @message_155196_data].each_with_index do |data, i|
      puts "\nMessage #{[155181, 155192, 155196][i]}:"
