...
class MessageTest < Minitest::Test
  ...
  def test_convenience_methods
    ...
    message = Object.new
    def message.is_from_me; @is_from_me; end
    def message.is_from_me=(value); @is_from_me = value; end
    def message.service; @service; end
    def message.service=(value); @service = value; end
    def message.associated_message_guid; @associated_message_guid; end
    def message.associated_message_guid=(value); @associated_message_guid = value; end
